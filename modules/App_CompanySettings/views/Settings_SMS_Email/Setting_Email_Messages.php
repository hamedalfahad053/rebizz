<div class="card card-custom card-stretch gutter-b">
    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
	        <a href="<?= base_url(APP_NAMESPACE_URL . '/Settings_SMS_Email/Form_Email_Messages') ?>" class="btn btn-success">
		    ...
		    ?>
			    <tr>
				    ...
				    <td class="text-center">
					    <?php
					    $options = array();
						$options['deleted'] = array("class" => '',"id" => '',"title" => 'حذف',"data-attribute" => '',"icon"  => '',"href"  => base_url(APP_NAMESPACE_URL . '/Settings_SMS_Email/Deleted_Messages/'.$ROW->messages_uuid));
