...
<!--	        <a href="--><?//= base_url(APP_NAMESPACE_URL.'/Settings/SettingEmailServer/') ?><!--" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 btn-block">اعداد خادم البريد الالكتروني</a>-->
	        <a href="<?= base_url(APP_NAMESPACE_URL.'/Settings_SMS_Email/Setting_SMS_Messages/') ?>" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 btn-block">اعداد رسائل النصية</a>
	        <a href="<?= base_url(APP_NAMESPACE_URL.'/Settings_SMS_Email/Setting_Email_Messages/') ?>" class="btn btn-hover-light-primary font-weight-bold py-3 px-6 mb-2 btn-block">اعداد رسائل البريد الالكتروني</a>
