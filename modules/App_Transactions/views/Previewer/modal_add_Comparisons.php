            ...
            <form id="Form_Comparisons"  action="#">
                ...
                <div class="modal-body">
	                ...
	                <div class="form-group row">
		                <div class="col-lg-6">
			                <label> الفئة  </label>
			                <?= Creation_List_HTML('select', 'LIST_COMPARISON_CATEGORY', '','','options', '','','','',array( 0=> "selectpicker"),'','','') ?>
		                </div>
		                <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
	                        ...
	                        <?= Creation_List_HTML('select', 'LIST_OPERATION_TYPE', '','','options', '','','','',array( 0=> "selectpicker"),'','','') ?>
                        </div>
...
<script type="text/javascript">
	...
	$('#Modal_Form_Comparisons').on('shown.bs.modal', function (event) {

		var map_Comparisons = new GMaps({ div: '#map_container_Comparisons' , lat: 23.7112692 , lng: 44.4579123 });
			...
			success: function(position) {
				...
				map_Comparisons.addMarker({
					...
					dragend: function(event) {
						...
						$("#map_content_Comparisons").css({"height": "300px","width": "100%"});
					},
					title: 'الموقع الحالي',
					infoWindow: {
	...
	$('#Form_Comparisons').on('click', '#Form_Comparisons_Submit', function (event) {
		...
		var Comparisons_type        = $('select[name=LIST_COMPARISON_CATEGORY]').val();
		var property_types_id       = $('select[name=property_types_id]').val();
		var LATITUDE_Comparisons    = $('input[name=LATITUDE_Comparisons]').val();
		var LONGITUDE_Comparisons   = $('input[name=LONGITUDE_Comparisons]').val();
		var LIST_OPERATION_TYPE     = $('select[name=LIST_OPERATION_TYPE]').val();
		...
		$.ajax({
			...
			data: {
				...
				total_value_property:total_value_property,
				office:office,
				office_tel:office_tel,
				LATITUDE_Comparisons:LATITUDE_Comparisons,
				LONGITUDE_Comparisons:LONGITUDE_Comparisons,
				LIST_OPERATION_TYPE:LIST_OPERATION_TYPE
			},
			async: false,
			dataType: 'json',
			success: function (response) {
				...
				//Form_Comparisons
				$('#Form_Comparisons').trigger("reset");
			},
			error: function () {
