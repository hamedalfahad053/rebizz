		        ...
		        <div class="card-body">
		            ...
		            <div class="form-group row">
			            ...
			            <div class="col-lg-6 mt-5">
				            ...
				            <input type="text" name="preview_date" class="form-control datepicker_time" placeholder=""/>
			            </div>
			        ...
			        <div class="row mt-10">
				        ...
				        <div class="col-lg-6"  id="preview_Email" style="display: none">
					        ...
					        <label class="checkbox mt-3">
						        <input type="checkbox" value="1"  id="Email" name="Email" onclick=""  />
						        <span></span>
...
<script type="text/javascript">
	...
	$(".datepicker_time").hijriDatePicker({
		hijri:false,
		format: "DD-MM-YYYY",
