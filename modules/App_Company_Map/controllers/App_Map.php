...
//        name_ar,name_en,city_id,center,region_id,countries_id From `portal_map_cities`  ");
//
//
...
//            //echo $c->Center_Point;
//
//            $colect  = ''.$c->Latitude.' '.$c->Longitude.'';
//            $name_ar = 'غير مسمى';
//            app()->db->query(" INSERT INTO `portal_map_districts` (city_id,region_id,countries_id,name_ar,name_en,boundaries)
//            VALUES ('$c->city_id','$c->region_id','$c->countries_id','$name_ar','Unnamed',GeomFromText('POLYGON(($colect))',4326)   )  ");
//
//        }
